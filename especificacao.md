...
- [7. Casos de uso](#7-casos-de-uso)
  ...
  - [7.1.8 Identificar Membros com perfil semelhante](#718-efetuar-pedido-para-o-cliente) 
  - [7.1.9 Pesquisar outros membros](#719-acessar-funções-restritas)
  - [7.2.1 Propor relacionamento de amizade](#721-efetuar-registro)
  - [7.2.2 Verificar pendências de amizade](#722-efetuar-seu-próprio-pedido)
  - [7.2.3 Listar avaliações realizadas pelo membro amigo](#723-efetuar-pedido-para-o-cliente) 
  - [7.2.4 Dar feedback nas avaliações do amigo](#724-acessar-funções-restritas)
  - [7.2.5 Retirar "joinha"](#725-efetuar-registro)
  - [7.2.6 Acessar próprio perfil](#726-efetuar-seu-próprio-pedido)
  - [7.2.7 Listar avaliações realizadas pelo membro logado](#727-efetuar-pedido-para-o-cliente)
  - [7.2.8 Listar amigos e recomendações recebidas](#728-efetuar-seu-próprio-pedido)
  - [7.2.9 Reunir avaliações do Item](#729-efetuar-pedido-para-o-cliente) 
  - [7.3.1 Ordenar joinhas de cada avaliação](#731-acessar-funções-restritas)
  - [7.3.2 Consultar Relatório](#732-efetuar-registro)
  - [7.3.3 Consultar Gráfico](#733-efetuar-seu-próprio-pedido)
  - [7.3.4 Consultar média de membros mais conectados](#734-efetuar-pedido-para-o-cliente)
  - [7.3.5 Consultar média de membros](#735-efetuar-pedido-para-o-cliente)
